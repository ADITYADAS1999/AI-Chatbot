...
my_bot = ChatBot("Chatterbot", storage_adapter="chatterbot.storage.SQLStorageAdapter")  # The SQLStorageAdapter allows ChatterBot to store conversation data in any database supported by the SQL Alchemy ORM. 
trainer = ChatterBotCorpusTrainer(my_bot)  # This is a corpus of dialog data that is included in the chatterbot module. Additional information about the chatterbot-corpus module can be found in the ChatterBot Corpus Documentation.
